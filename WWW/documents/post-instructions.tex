...
\begin{itemize}
    ...
    \item \emph{Main Post Image} (\texttt{"featured\_image\_src"}): A link to the main image that will be
    ...
    \item \emph{Team Name} (\texttt{"teams"}): The official name of the team or teams that have edited the
        post.
\end{itemize}
...
\begin{itemize}
    ...
    \item \emph{2-by-1 Post Image} (\texttt{"smaller\_img\_src"}): A link to a cropped version of the post image that
    ...
    \item \emph{Post Thumbnail} (\texttt{"square\_image\_src"}): A link to a cropped version of the post image
